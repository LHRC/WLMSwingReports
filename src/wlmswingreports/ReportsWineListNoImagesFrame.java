 ...
 * @author office
 */
public class ReportsWineListNoImagesFrame extends JInternalFrame
{
    /** Creates new form ReportsMiscWineStoriesFrame */
  public ReportsWineListNoImagesFrame()
  {
    super();
    getParameters();
    getCols();
...
//      JasperCompileManager.compileReportToFile(reportSource, compiledReport);
      ...
      InputStream jasper1 = getClass().getResourceAsStream("WineListNoImagesReport.jasper");
    ...
    private void getData()
    {
      ...
      String q = "select pi.wine_list_bin_number, " +
                 ...
                 "and pi.active = ? " +
                 "and pi.label_image_oid is null " +
  ...
  String compiledReport = reportPath + "WineListNoImagesReport.jasper";
  String reportSource = reportPath + "WineListNoImagesReport.jrxml";
