 ...
 * @author office
 */
public class ReportsMiscWineStoriesFrame extends JInternalFrame
{
    /** Creates new form ReportsMiscWineStoriesFrame */
  public ReportsMiscWineStoriesFrame()
  {
    super();
    getParameters();
    getCols();
...
//      JasperCompileManager.compileReportToFile(reportSource, compiledReport);
      ...
      InputStream jasper1 = getClass().getResourceAsStream("WineStoriesReport.jasper");
    ...
    private void getData()
    {
      ...
      String q = "select pi.wine_list_bin_number, " +
                 "pi.inventory_name, pi.pos_story " +
  ...
  String compiledReport = reportPath + "WineStoriesReport.jasper";
  String reportSource = reportPath + "WineStoriesReport.jrxml";
