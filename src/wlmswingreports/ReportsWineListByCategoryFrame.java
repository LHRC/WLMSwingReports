 ...
 */
public class ReportsWineListByCategoryFrame extends JInternalFrame
{

    /** Creates new form ReportsInventoryExtensionFrame */
    public ReportsWineListByCategoryFrame()
    {
      //super(mit);
      try
      {
...
//    JasperCompileManager.compileReportToFile(reportSource, compiledReport);
      ...
      InputStream jasper1 = getClass().getResourceAsStream("WineListByCategoryReport.jasper");
...
//          name.replace(",”", "”");
  ...
  String compiledReport = reportPath + "WineListByCategoryReport.jasper";
  String reportSource = reportPath + "WineListByCategoryReport.jrxml";
