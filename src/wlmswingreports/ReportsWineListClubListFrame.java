 ...
 */
public class ReportsWineListClubListFrame extends JInternalFrame
{

    /** Creates new form ReportsInventoryExtensionFrame */
    public ReportsWineListClubListFrame()
    {
      try
      {
        getAllocations();
  ...
  private void getData() throws SQLException
  {
     String q = "select wlc.wine_list_category_name, pi.wine_list_name, " +
              ...
              "where pi.is_club_list_selection and " +
...
//          name.replace(",”", "”");
  ...
  String compiledReport = "WineListClubListReport.jasper";
