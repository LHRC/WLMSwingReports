 ...
 */
public class ReportsWineListByBinFrame extends JInternalFrame
{

    /** Creates new form ReportsInventoryExtensionFrame */
    public ReportsWineListByBinFrame()
    {
      try
      {
        getAllocations();
  ...
  private void getData() throws SQLException
  {
     String q = "select wlc.wine_list_category_name, pi.wine_list_name, " +
              ...
              "order by pi.wine_list_bin_number, "+
...
//          name.replace(",”", "”");
  ...
  String compiledReport = "WineListByBinReport.jasper";
