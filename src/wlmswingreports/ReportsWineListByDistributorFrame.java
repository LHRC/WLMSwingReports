 ...
 */
public class ReportsWineListByDistributorFrame extends JInternalFrame
{

    /** Creates new form ReportsInventoryExtensionFrame */
    public ReportsWineListByDistributorFrame()
    {
      //super(mit);
      try
      {
...
//    JasperCompileManager.compileReportToFile(reportSource, compiledReport);
      ...
      InputStream jasper1 = getClass().getResourceAsStream("WineListByDistributorReport.jasper");
...
//          name.replace(",”", "”");
      ...
      line.add(rs.getString("company_name"));
...
//  String compiledReport = reportPath + "WineListByDistributorReport.jasper";
  String reportSource = reportPath + "WineListByDistributorReport.jrxml";
